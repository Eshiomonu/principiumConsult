          ...
          <div class="col-xl-4 col-md-6" data-aos="zoom-in" data-aos-delay="200">
            <div class="service-item">
              ...
              <div class="m-details">
                ...
                <p>To be the leading consulting firm for sustainable growth and ethical leadership, empowering businesses to achieve success while contributing positively to society and the environment.
                </p>
              </div>
            </div>
          </div><!-- End Vision Item -->
          ...
          <div class="col-xl-4 col-md-6" data-aos="zoom-in" data-aos-delay="200">
            <div class="service-item">
              ...
              <div class="m-details">
                ...
                <p>Our mission is to provide business owners with tailored strategies and training that integrate sustainability and principled leadership, ensuring resilience, innovation, and impactful transformation across industries.
                </p>
              </div>
            </div>
          </div><!-- End Vision Item -->
          ...
          <div class="col-xl-4 col-md-6" data-aos="zoom-in" data-aos-delay="200">
            <div class="service-item">
              ...
              <div class="m-details">
                ...
                <p>To inspire and guide businesses toward sustainable growth by instilling foundational leadership practices and delivering strategies that empower owners to achieve their vision and turn their aspirations into thriving successes</p>
              </div>
            </div>
          </div><!-- End Vision Item -->
        ...
        <div class="row gy-5">
          <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <iframe width="420" height="315"
              src="https://youtube.com/embed/xs7aMritwvg">
            </iframe>
          ...
          <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <iframe width="420" height="315"
              src="https://youtube.com/embed/shorts/7R-KnAslJw0">
            </iframe>
          ...
          <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <iframe width="420" height="315"
              src="https://youtube.com/embed/shorts/lly-MdGQPHw">
            </iframe>
