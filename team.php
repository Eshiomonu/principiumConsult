  ...
  <main class="main">
    ...
    <section class="dark-background">
      <div class="container mt-4 p-4 text-center">
        <h2 style="color: whitesmoke;">TEAM PAGE</h2>
      </div>
      ...
      <div class="container">
        <div class="row gy-5">
          ...
          <div class="col-lg-6 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="member">
              ...
              <div class="member-info">
                <h4>Ajayi Babawale</h4>
                <span>Director / Chief Trainer</span>
                <div class="social">
          ...
          <div class="col-lg-6 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="member">
              <div class="pic"><img src="assets/img/team/kadiri.png" class="img-fluid" alt=""></div>
              <div class="member-info">
                <h4>Kadiri Eshiomonu</h4>
                <span>Partner / Coordinator</span>
                <div class="social">
                  <a href=""><i class="bi bi-twitter-x"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
                  <a href=""><i class="bi bi-instagram"></i></a>
          ...
          <div class="col-lg-6 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="member">
              <div class="pic"><img src="assets/img/team/Lisa Onu.jpg" class="img-fluid" alt="Lisa Onu"></div>
              <div class="member-info">
                <h4>Lisa Onu</h4>
                <span>Director</span>
                <div class="social">
          ...
          <div class="col-lg-6 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="member">
              <div class="pic"><img src="assets/img/team/Taribi Krukrubo Jack.jpg" class="img-fluid" alt="Lisa Onu"></div>
              <div class="member-info">
                <h4>Taribi Krukrubo Jack</h4>
                <span>Director</span>
                <div class="social">
                  <a href=""><i class="bi bi-twitter-x"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
